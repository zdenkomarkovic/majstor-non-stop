      ...
      <section className="py-20 bg-gradient-to-br from-gray-200 to-white">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Naše Usluge</h2>
            <p className="text-xl text-gray-900 max-w-3xl mx-auto">
              Pružamo hitne majstorske usluge u Nišu i okolini. Naš tim
              stručnjaka je uvek spreman da odgovori na vaš poziv. Hausmajstor u
              Nišu i okolini.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Hitne bravarske usluge - izgubljeni kljucevi, polomljene
        ...
        <div className="container mx-auto px-4 text-center flex flex-col-reverse md:flex-row gap-3 justify-center items-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Pozovite nas odmah! Naš tim je spreman da odgovori na vaš poziv 24
              sata dnevno. Hausmajstor u Nišu i okolini.
            </p>
            <a
              href="tel:+381607182300"
              onClick={() => window.gtag_report_conversion?.('tel:+381607182300')}
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-900 max-w-3xl mx-auto">
              Naš tim stručnjaka sa višegodišnjim iskustvom garantuje kvalitet i
              brzinu
            </p>
          </motion.div>
