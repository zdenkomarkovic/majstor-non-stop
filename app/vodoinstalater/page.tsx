...
import { Phone, Clock, Droplets, Shield, CheckCircle, AlertTriangle, Wrench, Home, Building } from "lucide-react";
    ...
    <div className="min-h-screen ">
      ...
      <section className="relative min-h-[70vh] flex items-end justify-center overflow-hidden">
        ...
        <div className="relative  text-center text-white flex flex-col items-center justify-end h-full text-white px-4 max-w-4xl mx-auto mb-5 md:mb-10 ">
          ...
          >
            Rešavamo sve probleme sa vodom - pucanje cevi, curenje, kvarovi u instalacijama. 
            Brza i efikasna rešenja kada su najpotrebnija.
          </motion.p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-900 max-w-3xl mx-auto">
              Pružamo kompletan spektar vodoinstalaterskih usluga u Nišu i okolini. 
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex items-center gap-4 justify-center">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900">Stambeni objekti</h4>
              ...
              <div className="flex items-center gap-4 justify-center">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900">Komercijalni objekti</h4>
                  <p className="text-gray-600">Kancelarije, restorani, prodavnice</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container mx-auto px-4 text-center flex flex-col-reverse md:flex-row gap-3 justify-center items-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Ne čekajte! Pozovite nas odmah za hitnu vodoinstalatersku intervenciju. 
              Naš tim je spreman da odgovori na vaš poziv 24 sata dnevno. Hausmajstor u Nišu i okolini.
            </p>
            <Link 
      ...
      <section className="py-20 bg-gradient-to-br from-gray-200 to-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-900 max-w-3xl mx-auto">
              Naš tim vodoinstalatera sa višegodišnjim iskustvom garantuje kvalitet i brzinu
            </p>
          </motion.div>
