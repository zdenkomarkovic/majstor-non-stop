...
import { Phone, Clock, Key, Shield, CheckCircle, AlertTriangle, Wrench, Home, Building, Lock } from "lucide-react";
      ...
      <section className="py-20 bg-gradient-to-br from-gray-200 to-white">
        ...
        <div className="container mx-auto px-4 text-center flex gap-10 justify-center items-center">
          ...
          >
            ...
            Ne čekajte! Pozovite nas odmah za hitnu bravarsku intervenciju. Naš tim je spreman da odgovori na vaš poziv 24 sata dnevno.
            </p>
            <Link 
