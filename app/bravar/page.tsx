    ...
    <div className="min-h-screen ">
      ...
      <section className="relative min-h-[70vh] flex items-end justify-center overflow-hidden">
        ...
        <div className="relative  text-center text-white flex flex-col items-center justify-end h-full text-white px-4 max-w-4xl mx-auto mb-5 md:mb-10 ">
          ...
          >
            Rešavamo sve bravarske probleme - izgubljeni kljucevi, polomljene
            brave, otključavanje. Brza pomoć kada je najpotrebnija.
          </motion.p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-900 max-w-3xl mx-auto">
              Pružamo kompletan spektar bravarskih usluga u Nišu i okolini. Naš
              tim stručnjaka je uvek spreman da odgovori na hitne pozive.
              Hausmajstor u Nišu i okolini.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 text-center flex flex-col-reverse md:flex-row gap-3 justify-center items-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Ne čekajte! Pozovite nas odmah za hitnu bravarsku intervenciju.
              Naš tim je spreman da odgovori na vaš poziv 24 sata dnevno.
              Hausmajstor u Nišu i okolini.
            </p>
            <a
      ...
      <section className="py-20 bg-gradient-to-br from-gray-200 to-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-900 max-w-3xl mx-auto">
              Naš tim bravara sa višegodišnjim iskustvom garantuje kvalitet i
              sigurnost
            </p>
          </motion.div>
